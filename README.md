# armanda-runbook (course-setup-runbook)
...
2. Вставь ему **одно** сообщение и отправь:
   > Склонируй репозиторий `https://github.com/bronxtc52/armanda-runbook`, зайди в его папку, прочитай файл `AGENTS.md` и делай ровно то, что там написано — веди меня как гид с самого начала.
